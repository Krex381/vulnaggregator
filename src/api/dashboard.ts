...
body{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;background:#0d1117;color:#c9d1d9;padding:2rem;font-size:14px}
h1{font-weight:400;font-size:1.25rem;color:#58a6ff;margin-bottom:1.5rem;letter-spacing:-.02em}
h2{font-weight:400;font-size:.75rem;color:#8b949e;text-transform:uppercase;letter-spacing:.05em;margin-bottom:.5rem}
.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:1rem;margin-bottom:1.5rem}
.card{background:#161b22;border:1px solid #30363d;padding:1rem}
.card .val{font-size:1.5rem;color:#f0f6fc;font-weight:600}
.table-wrap{overflow-x:auto;margin-bottom:1.5rem}
table{width:100%;border-collapse:collapse;font-size:.8125rem}
th{text-align:left;padding:.5rem .75rem;border-bottom:1px solid #30363d;color:#8b949e;font-weight:400;white-space:nowrap}
td{padding:.5rem .75rem;border-bottom:1px solid #21262d}
tr:hover td{background:#161b22}
.ok{color:#3fb950}
.fail{color:#f85149}
a{color:#58a6ff;text-decoration:none}
.err{padding:2rem;color:#f85149;border:1px solid #30363d}
.footer{margin-top:2rem;padding-top:1rem;border-top:1px solid #21262d;font-size:.75rem;color:#8b949e;text-align:center}
.footer a{color:#8b949e}.footer a:hover{color:#58a6ff}
</style>
</head>
<body>
...
<div id="app">
<div class="grid">
<div class="card"><h2>Vulnerabilities</h2><div class="val" id="total">-</div></div>
<div class="card"><h2>Sources</h2><div class="val" id="sources">-</div></div>
<div class="card"><h2>Uptime</h2><div class="val" id="uptime">-</div></div>
<div class="card"><h2>24h</h2><div class="val" id="last24h">-</div></div>
</div>
<div class="table-wrap"><h2>Severity</h2><table id="severity"></table></div>
<div class="table-wrap"><h2>Sources</h2><table id="source-table"><thead><tr><th>Source</th><th>Status</th><th>Errors</th></tr></thead><tbody></tbody></table></div>
